    ...
    render() {
        ...
        return(
            <TableRow>
                ...
                {this.state.addressesDialog && <AddressesDialog key={address._id} userId={userId} address={address} open={this.state.addressesDialog} close={this.toggleAddressesDialog} add={false} type={"shipping"}/>}
            </TableRow>
        )
    }
}
